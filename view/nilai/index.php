    ...
    <div class="jumbotron jumbotron-fluid bg-light" style="height:90vh">
        <div class="container">
            ...
            <table border="1">
                ...
                ?>
                    <tr>
                        <td><?php echo $d['kd_nilai']; ?></td>
                        <td><?php echo $d['nis']; ?></td>
                        <td><?php echo $d['nm_siswa']; ?></td>
                        <td><?php echo $d['kd_matpel']; ?></td>
                        <td><?php echo $d['nm_matpel']; ?></td>
                        <td><?php echo $d['uts_sem_ganjil']; ?></td>
                        <td><?php echo $d['uas_sem_ganjil']; ?></td>
                        <td><?php echo $d['uts_sem_genap']; ?></td>
                        <td><?php echo $d['uas_sem_genap']; ?></td>
                        <td>
                            <a href="edit.php?kd_nilai=<?php echo $d['kd_nilai']; ?>">EDIT</a>
                            <a href="hapus.php?kd_nilai=<?php echo $d['kd_nilai']; ?>">HAPUS</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
